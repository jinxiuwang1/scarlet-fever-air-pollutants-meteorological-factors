...
output_dir <- "E:/Scarlet Fever/Figure12"
...
data <- read.csv(
  "E:/scarletfever_2013-2020_2.csv",
...
cat("EPS figure saved: ",
    file.path(output_dir, "Multivariate cumulative curve graph.eps"),
    "\n",
    sep = "")

cat("PNG figure saved: ",
    file.path(output_dir, "Multivariate cumulative curve graph .png"),
    "\n",
    sep = "")
